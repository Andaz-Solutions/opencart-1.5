<div class="left">
  ...
  <input type="text" name="telephone" value="" class="large-field" /><br />
    ...
    <input type="text" name="date_of_birth" value="<?php echo $date_of_birth; ?>" placeholder="YYYYMMDD" class="large-field" />
    <br />
    <span class="required">*</span> <?php echo $entry_social_security_number; ?><br />
    <input type="text" name="social_security_number" value="<?php echo $social_security_number; ?>" placeholder="XXXX" class="large-field" />
    <br />
  <br />
