...
class ControllerCheckoutGuest extends Controller
{
    public function index()
    {
        ...
        $this->data['entry_social_security_number'] = $this->language->get('entry_social_security_number');
        ...
        if (isset($this->session->data['guest']['social_security_number'])) {
            $this->data['social_security_number'] = $this->session->data['guest']['social_security_number'];
        } else {
            $this->data['social_security_number'] = '';
        }
    ...
    public function validate()
    {
        ...
        if (!$json) {
            ...
            if ((utf8_strlen($this->request->post['date_of_birth']) !== 8)) {
            ...
            if ($country_info['iso_code_2'] == 'US' && (utf8_strlen($this->request->post['social_security_number']) !== 4)) {
                $json['error']['social_security_number'] = $this->language->get('error_social_security_number');
            }
        ...
        if (!$json) {
            ...
            $this->session->data['guest']['social_security_number'] = $this->request->post['social_security_number'];
            ...
            if ($this->session->data['guest']['shipping_address']) {
                ...
                $this->session->data['date_of_birth'] = $this->request->post['date_of_birth'];
                $this->session->data['social_security_number'] = $this->request->post['social_security_number'];
            }
